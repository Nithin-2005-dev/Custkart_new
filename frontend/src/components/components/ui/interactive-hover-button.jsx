  ...
  return (
    (<button
      ...
      <div className="flex items-center gap-2">
        <div
          className="h-0 w-0 text-center rounded-full bg-primary transition-all duration-300 group-hover:scale-[100.8] bg-slate-500"></div>
        <span
          className="inline-block transition-all duration-300 group-hover:translate-x-12 group-hover:opacity-0 text-center">
          {children}
        </span>
      </div>
      <div
