      ...
      <div className="w-full max-w-md p-8  rounded-lg shadow-lg shadow-slate-500 bg-gray-300">
        ...
        <div className="space-y-6">
          <div>
            ...
            />
            <p className='bg-red-600 mt-2 p-1 px-2 rounded-lg hover:bg-red-500 inline-block cursor-pointer' onClick={async()=>{
        ...
        {otp && <div>
          ...
          <button
            type="submit"
            className="w-full px-4 py-2 font-bold text-white bg-green-600 rounded-md hover:bg-green-700" onClick={()=>{
                console.log(otp);
                verifyEmail(otp,otpRef.current.value)
            }} 
          >
            Verify
          </button>
